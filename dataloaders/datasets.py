...
class TrainDataset(Dataset):
    ...
    def __init__(self, args):
        ...
        ###################### NO FOLD VALIDATION ############################
        self.image_dirs = [elem for idx, elem in enumerate(self.image_dirs)]
        self.label_dirs = [elem for idx, elem in enumerate(self.label_dirs)]
        self.sprvxl_dirs = [elem for idx, elem in enumerate(self.sprvxl_dirs)]
